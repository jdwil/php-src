...
#line 1272 "Zend/zend_language_scanner.l"
		{
    yy_push_state(ST_LOOKING_FOR_TYPE);
...
#line 1302 "Zend/zend_language_scanner.l"
		{
    yy_push_state(ST_IN_TYPE);
    RETURN_TOKEN(T_OPEN_TYPE);
}
